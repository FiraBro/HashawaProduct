...
//   const [currentImageIndex, setCurrentImageIndex] = useState({}); // Track current image index for each variant
...
//         setProducts(data);
//         setLoading(false);
//         // Initialize currentImageIndex state
...
//     console.log("Added to cart:", product.name, variant.color);
